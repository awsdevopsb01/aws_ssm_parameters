...
docdb_parm = [
  ...
  { name = "dev.catalogue.mongo_endpoint", value = "mongodb://roboshop:roboshop123@mongodb:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false"},
  ...
  { name = "dev.user.mongo.nldevopsb01_url", value = "mongodb://roboshop:roboshop123@mongodb:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false"},
