...
docdb_parm = [
  ...
  { name = "dev.catalogue.mongo_endpoint", value = "mongodb://roboshop:roboshop123@docdb-dev-docdb.cluster-cxsscyyqa3vf.us-east-1.docdb.amazonaws.com:27017/catalogue?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false"},
  { name = "dev.docdb.mongo_url", value = "docdb-dev-docdb.cluster-cxsscyyqa3vf.us-east-1.docdb.amazonaws.com" },
  { name = "dev.user.ecache.nldevopsb01_url", value = "REDIS_HOST=elasticache-dev-elasticache-rpg.nlbmd7.ng.0001.use1.cache.amazonaws.com" },
  { name = "dev.user.mongo.nldevopsb01_url", value = "mongodb://roboshop:roboshop123@docdb-dev-docdb.cluster-cxsscyyqa3vf.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false"},
